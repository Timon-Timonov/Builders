...
public final class ParameterNames {
    ...
    public static final String DTO_LIST_PARAM = "dto_list";
    ...
    public static final String MONEY_TRANSFER_ID_PARAM = "money_transfer_id";
    ...
    public static final String NEW_USER_STATUS_PARAM = "new_user_status";
    public static final String NEW_PROJECT_STATUS_PARAM = "new_project_status";
