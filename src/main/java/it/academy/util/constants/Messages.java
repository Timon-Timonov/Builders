...
public final class Messages {
    ...
    public static final String WORK_PRICE_UPDATED_ID = "Workprice updated. id=";
    public static final String VALUE = ", value=";
    public static final String WORK_PRICE_NOT_UPDATED_ID = "Workprice not updated. id=";
    ...
    public static final String DATA_ALREADY_EXIST_IN_DB_ID = "Data alredy exist in DB. id=";
